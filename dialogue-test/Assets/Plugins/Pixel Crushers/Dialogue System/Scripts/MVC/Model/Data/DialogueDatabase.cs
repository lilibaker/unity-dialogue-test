        ...
        public string GetEntrytag(Conversation conversation, DialogueEntry entry, EntrytagFormat entrytagFormat)
        {
            ...
            switch (entrytagFormat)
            {
                ...
                case EntrytagFormat.VoiceOverFile:
                    return (entry == null) ? InvalidEntrytag : entrytagRegex.Replace(Field.LookupValue(entry.fields, VoiceOverFileFieldName), "_");
                case EntrytagFormat.Title:
                    return (entry == null) ? InvalidEntrytag : entrytagRegex.Replace(Field.LookupValue(entry.fields, DialogueSystemFields.Title), "_");
